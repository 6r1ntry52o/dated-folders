...
describe('week folder with ISO week number (strict ISO: Monday-based)', () => {
	...
	it('week folders are two levels deep (no month folder)', () => {
		expect(datedSegments('week', d(2026, 9, 19), 1, { weekNumber: true })).toEqual(['2026', '09-14(W38)']);
		expect(datedSegments('week', d(2026, 9, 19), 1)).toEqual(['2026', '09-14']);
	});
...
describe('datedSegments', () => {
	it('day is 3 segments, week is 2', () => {
